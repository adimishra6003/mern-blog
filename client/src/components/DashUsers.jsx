...
export default function DashUsers() {
  ...
  const handleShowMore = async () => {
    ...
    try {
      ...
      const data = await res.json();
      if (res.ok) {
        //Here, we are adding new posts (from startIndex to remaining) to the userPosts state variable array.
                ...
                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <Table.Cell>
                    <img
                      ...
                      alt={user.username}
                      className="w-10 h-10 object-hover bg-gray-500 rounded-full"
                    />
                  </Table.Cell>
